...
from arguments import T_hot, topography_shape, spatial_dims # Parameters from command line
from parameters import T_inf, u_ast, k, d, u_z_0, u_r, z_r, alpha_u, initial_u_type, fuel_height, T0_shape, T0_x_start, T0_x_end, T0_y_start, T0_y_end, T0_z_start, T0_z_end, T0_x_center, T0_y_center, T0_length, T0_width, T0_height
