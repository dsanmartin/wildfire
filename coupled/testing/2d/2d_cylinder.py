...
samples = 1 # Samples to store data
# Arrays
...
conser = False
# Cylinder
x_0_C, y_0_C = (x_max - x_min) / 6, (y_max - y_min) / 2 # Base center
R = .2 # radius
centers = [[x_0_C, y_0_C + 1], [x_0_C, y_0_C - 1]] # All centers
radiuses = [R, R] # All radiuses
...
np.savez('../output/2d_cylinder_test_{}.npz'.format(turb_str), U=U, V=V, P=P, x=x, y=y, t=t[::samples])