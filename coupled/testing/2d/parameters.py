...
y_min, y_max = 0, 400 # Distance interval [y_min, y_max] in m
t_min, t_max = 0, 240 # Time interval [t_min, t_max] in s

# Numerical grid
Nx, Ny, Nt = 256, 256, 12001 # Number of nodes per axis
# Nx, Ny, Nt = 128, 128, 1001 # Number of nodes per axis
...
H_R = 500 # Heat energy per unit of mass (wood) in J kg^{-1}. About 21.20e6 for wood according to https://en.wikipedia.org/wiki/Heat_of_combustion
